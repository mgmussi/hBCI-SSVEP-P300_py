...
"""
Updates from v1:
- Using lists to append to spear processing time
- Removing unecessary code (dummy code)
- Replacing BUTTER with a FIR filter - ok
- Simplifying SSVEP processing
...
def init_dialog():
	...
	session_info = {'ParticipantID':'00', 'SessionNumber':'01', 'Version': 8.2, 'Headset':['','cyton', 'gtec']}
