...
- Included FIR filter
- Minor optimizations
- Replicating conditioning of _testMNE.py
- Adding ICA filtering
'''
...
##BUTTERWORTH
b, a = butter(1, [low, high], btype='bandpass') # b, a = butter(order, [low, high], btype='band')
delay = 0 
...
def get_data_files():
	...
	return ch_data_125, ch_data_all, ts_data, p300ll_data, ssvepll_data, ssvepll_data_all, dir_name
...
if __name__ == '__main__':
	...
	eeg_data, eeg_data_all, timestamps, P300_lbls, SSVEP_lbls, SSVEP_lbls_all, dir_ = get_data_files() #all numpy arrays
