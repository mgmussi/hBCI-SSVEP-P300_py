...
class FlickeringBoxes:
	def __init__(self, position):
		...
		self.Sq0_v = visual.MovieStim3(self.win, "vids\Sq0_final.mp4", pos = self.p[0], loop = True)
		# self.Sq1_v = visual.MovieStim3(self.win, "vids\Sq1_final.mp4", pos = self.p[1])
		self.Sq2_v = visual.MovieStim3(self.win, "vids\Sq2_final.mp4", pos = self.p[2])
